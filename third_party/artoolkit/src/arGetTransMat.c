...
void argConvGlpara(double para[3][4], double* gl_para)
{
    int     i, j;
...
double arGetTransMat4x4(ARMarkerInfo *marker_info,
    double center[2], double width, double* conv)
{
    double tmp[3][4];
    double ret = arGetTransMat(marker_info, center, width, tmp);
    argConvGlpara(tmp, conv);
    return ret;
}
